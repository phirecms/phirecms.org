...
abstract class AbstractController extends \Pop\Controller\AbstractController
{
    ...
    protected function prepareView($template)
    {
        ...
        if (file_exists(__DIR__ . '/../../../public/assets/downloads/phire-cms-' . $version . '.zip')) {
            $zip = $this->formatFileSize(filesize(__DIR__ . '/../../../public/assets/downloads/phire-cms-' . $version . '.zip'));
        }
        if (file_exists(__DIR__ . '/../../../public/assets/downloads/phire-cms-' . $version . '.tar.gz')) {
            $tgz = $this->formatFileSize(filesize(__DIR__ . '/../../../public/assets/downloads/phire-cms-' . $version . '.tar.gz'));
        }
        if (file_exists(__DIR__ . '/../../../public/assets/downloads/phire-cms-' . $version . '.tar.bz2')) {
            $tbz = $this->formatFileSize(filesize(__DIR__ . '/../../../public/assets/downloads/phire-cms-' . $version . '.tar.bz2'));
        }
